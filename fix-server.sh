#!/bin/bash
# Script para corrigir o servidor de produção
...
# Remover node_modules para rebuild limpo
...
# Atualizar controllers para Drizzle ORM
...
echo "📝 Atualizando slidesController..."
...
echo "📝 Criando controllers restantes..."
